...
import type { NavigationPayload, SettingsPayload } from 'types'

import Layout from '../../shared/Layout'
import NavigationPageHead from './NavigationPageHead'
...
export function NavigationPage({
  ...
  return (
    <>
      <NavigationPageHead navigation={navigation} title={homePageTitle} />
