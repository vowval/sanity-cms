...
import type { PartnersPayload, SettingsPayload } from 'types'

import Layout from '../../shared/Layout'
import PartnersPageHead from './PartnersPageHead'
...
export function PartnersPage({
  ...
  return (
    <>
      <PartnersPageHead partners={partners} title={homePageTitle} />
