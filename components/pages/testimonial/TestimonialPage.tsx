...
import type { TestimonialPayload, SettingsPayload } from 'types'

import Layout from '../../shared/Layout'
import TestimonialPageHead from './TestimonialPageHead'
...
export function TestimonialPage({
  ...
  return (
    <>
      <TestimonialPageHead testimonial={testimonial} title={homePageTitle} />
