...
import type { RecommendPayload, SettingsPayload } from 'types'

import Layout from '../../shared/Layout'
import RecommendPageHead from './RecommendPageHead'
...
export function RecommendPage({
  ...
  return (
    <>
      <RecommendPageHead recommend={recommend} title={homePageTitle} />
